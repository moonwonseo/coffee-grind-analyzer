...
DATASETS = [
    ...
    # Best fit — rice/corn/wheat polygon masks
    ("winxos-16ly4",           "grain-3z0bc",               11, "yolov8"),
    # Powder/particle segmentation — try a few versions
    ("particleresearch",       "particlesegmentation-ifufn", 2,  "yolov8"),
    # Grain detection
    ("thorbjorg-petursdottir", "particles-wwk5m",            2,  "yolov8"),
]
